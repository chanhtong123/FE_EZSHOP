  ...
  return (
    <div className="product">
      ...
      <img
        ...
        src="/arrows1.svg"
      />
      <img className="arrows-1-icon9" alt="" src="/arrows1-1.svg" />
                  ...
                  <div className="phone-support">
                    ...
                    <div className="call-center">
                      ...
                      <div className="bn-cn-tr-container1">
                        ...
                        <span className="span24">+84 1800 900</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="center1">
              ...
              <div className="search-navigation1">
                ...
                <div className="right-box1">
                  <div className="items8" onClick={onItemsContainerClick}>
                    ...
                    <div className="wishlist-login">
                      <div className="yu-thch-sn-container1">
                        <p className="yu-thch1">Yêu thích</p>
                        <p className="sn-phm4">Sản phẩm</p>
                      </div>
                    </div>
                    <img
                      className="heart-1-icon1"
                      loading="lazy"
                      alt=""
                      src="/heart-1-1.svg"
                    />
                  ...
                  <div className="cart2" onClick={onCartContainerClick}>
                ...
                <div className="nav-wrapper">
                  <div className="nav1">
                    <div className="trang-ch-parent">
                      <div className="trang-ch2" onClick={onTrangChTextClick}>
                        Trang chủ
                      </div>
            ...
            <div className="top-wrapper">
              <div className="top3">
                <div className="hin-th-120-trong-175-kt-qu-parent">
                  ...
                  <div className="div72">20</div>
                  <div className="frame-child4" />
                  <div className="div73">40</div>
                  <div className="frame-child5" />
                  <div className="div74">60</div>
                      ...
                      <div className="radio-container">
                        ...
                        <div className="frame-wrapper5">
                          <div className="star-1-1-container">
                            <img
                              className="star-1-113"
                              alt=""
                              src="/star-1-1.svg"
                            />
                            <img
                              className="star-1-213"
                              alt=""
                              src="/star-1-1.svg"
                            />
                            <img
                              className="star-1-313"
                              alt=""
                              src="/star-1-5-4.svg"
                            />
                            <img
                              className="star-1-413"
                              alt=""
                              src="/star-1-5-4.svg"
                            />
                            <img
                              className="star-1-513"
                              alt=""
                              src="/star-1-5-4.svg"
                            />
                          </div>
                      ...
                      <div className="radio-parent1">
                        ...
                        <div className="frame-wrapper6">
                          <div className="star-1-1-parent1">
                            <img
                              className="star-1-114"
                              alt=""
                              src="/star-1-1.svg"
                            />
                            <img
                              className="star-1-214"
                              alt=""
                              src="/star-1-5-4.svg"
                            />
                            <img
                              className="star-1-314"
                              alt=""
                              src="/star-1-5-4.svg"
                            />
                            <img
                              className="star-1-414"
                              alt=""
                              src="/star-1-5-4.svg"
                            />
                            <img
                              className="star-1-514"
                              alt=""
                              src="/star-1-5-4.svg"
                            />
                          </div>
              ...
              <div className="panigation">
                <div className="navigation">
                  <div className="arrow2">
                    <img
                      className="arrows-1-icon10"
                      alt=""
                      src="/arrows1-2.svg"
                    />
                    <img
                      className="arrows-1-icon11"
                      alt=""
                      src="/arrows1-3.svg"
                    />
                  </div>
            ...
            <div className="preferences">
              ...
              <div className="language1">
                ...
                <div className="vector-wrapper12">
                  <img className="vector-icon14" alt="" src="/vector-8.svg" />
                </div>
              </div>
            </div>
          </div>
