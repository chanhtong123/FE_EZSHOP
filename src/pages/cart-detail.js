                  ...
                  <div className="div84">
                    ...
                    <div className="frame-parent7">
                      ...
                      <div className="bn-cn-tr-container">
                        ...
                        <span className="span20">+84 1800 900</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="rights">
                  <div className="div85">
                    ...
                    <div className="lang-icon">
                      <img className="icon11" alt="" src="/vector-10.svg" />
                    </div>
                  </div>
                ...
                <div className="bottom-nav">
                  <div className="nav">
                    <div className="bottom-links">
                      <div className="trang-ch1" onClick={onTrangChTextClick}>
                        Trang chủ
                      </div>
      ...
      <div className="breadcrumb-container">
        <div className="breadcrumb1">
          <div className="breadcrumb2">
            <div className="trang-ch2" onClick={onTrangChText1Click}>
              Trang chủ
            </div>
            ...
            <div className="table-container">
                      ...
                      <div className="quantity-wrapper">
                        <div className="quantity3">
                          ...
                          <div className="counter1">
                            <div className="quantity-display1">3</div>
                          </div>
                          <div className="plus2">
              ...
              <div className="sidebar">
                ...
                <div className="checkout-button-parent">
                  ...
                  <div
                    className="large-button-radius-613"
                    onClick={onLargeButtonRadius6ContainerClick}
                  >
                    <div className="shop-now10" onClick={onShopNowTextClick}>
                      Thanh toán ngay
                    </div>
                  </div>
                </div>
