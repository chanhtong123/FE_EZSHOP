...
const FrameComponent1 = ({
  ...
  return (
    <div className="frame-parent27">
      <div className="frame-parent28" style={frameDiv1Style}>
        <div className="frame-parent29" style={frameDiv2Style}>
      ...
      <div className="div169">
        <p className="p14">87</p>
        <p className="p15">92</p>
        <p className="p16">123</p>
        <p className="p17">49</p>
        <p className="p18">12</p>
      </div>
    </div>
  );
};
